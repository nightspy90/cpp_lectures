...
{
    [static_cast<int>(Product::benchpress)]     = "benchpress",
    [static_cast<int>(Product::barbell)]        = "barbell",
    [static_cast<int>(Product::dumbbell)]       = "dumbbell",
    [static_cast<int>(Product::leg_curler)]     = "leg_curler",
    [static_cast<int>(Product::leg_press)]      = "leg_press",
    [static_cast<int>(Product::EZ_barbell)]     = "EZ_barbell",
    [static_cast<int>(Product::shoulder_press)] = "shoulder_press",
    [static_cast<int>(Product::Treadmill)]      = "Treadmill",
    [static_cast<int>(Product::elliptical)]     = "elliptical",
    [static_cast<int>(Product::smith_machine)]  = "smith_machine",
};
...
struct Item
{
        ...
        Item(const Product prod, const std::string& name, const float price, const int nstock, const int proddate) :
                id {prod}, name {name}, price {price}, nstock {nstock}, proddate {proddate}
        {}
        auto print() const {std::printf ("%32s%64s%16.2f%8d%42d\n", get_product_name(id).data(), name.c_str(), price, nstock, proddate); }
};
